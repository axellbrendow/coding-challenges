...
by an array H of N positive integers. H[I] is the height of the wall from I to I+1 meters to the right of its
...
public class StoneWall {
  public static int solution(int[] H) {
    ...
    for (int i = 1; i < H.length; i++) {
      while (!stack.isEmpty() && stack.peek() > H[i]) stack.pop();
  ...
  public static void main(String[] args) {
    assert solution(new int[]{5, 5, 2, 4, 6, 5, 4, 1, 5}) == 7;
    assert solution(new int[]{5, 5, 2, 3, 6, 7, 3, 1, 5}) == 7;
  }
}
